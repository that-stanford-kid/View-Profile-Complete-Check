...
def count_crosses(ver_strokes, hor_strokes):
    ...
    # ver_strokes chosen as the smallest container
    # the reason will iterate over ver_strokes, while we will use log-time operation for hor_strokes
...
def build_tests(test=None, N=2_000_000):
    import random
